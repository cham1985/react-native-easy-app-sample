...
const imgUrl =
  'https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=108036961,3500928712&fm=26&gp=0.jpg';
        ...
        <ScrollView>
          ...
          <XView style={styles.iconTextParent}>
            ...
            <XText
              style={styles.iconText}
              text="文本"
              icon={require('../../../../images/conan.jpeg')}
              iconSize={20}
              iconPosition="right"
            />
            <XText
          ...
          <XText
            style={styles.rnTextItem}
            text="订单"
            icon={ImageRes.right_arrow}
            iconSize={16}
            iconPosition="right"
            textExtend={true}
            onPress={() => showToast('点击了订单')}
          />
          <XView style={{backgroundColor: Colors.white, marginBottom: 30}}>
            <XText
              style={styles.rnSearch}
              text="请输入客户姓名..."
              icon={ImageRes.search_icon}
              iconSize={16}
              iconPosition="left"
              iconMargin={6}
              onPress={() => showToast('点击跳转去搜索')}
            />
          </XView>
          <XView
            style={{
            ...
            />
            <XImage
              style={styles.rnImage}
              icon={imgUrl}
              onPress={() => showToast('柯南')}
            />
            <XImage
              style={{width: 65, height: 65}}
              icon={ImageRes.mine_setting}
              onPress={() => showToast('点击事件')}
            />
            <XImage
              style={{width: 65, height: 65}}
          ...
          <Image
            ...
            source={require('../../../../images/conan.jpeg')}
          />
        </ScrollView>
      </>
    );
